...
description: Use individual UI Kit components to build a custom meeting interface.
sidebar:
  order: 4
---
...
This page builds upon the [Initialize SDK](/realtime/realtimekit/core/), [Render Default Meeting UI](/realtime/realtimekit/ui-kit/), and [UI Kit States](/realtime/realtimekit/ui-kit/state-management/) guides. Read those first.
